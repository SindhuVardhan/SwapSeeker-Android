...
class OldActivity : AppCompatActivity(), ProductAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.oldRecyclerView)
        ...
        fetchProductsFromFirebase("Old_Is_Gold")
    }
